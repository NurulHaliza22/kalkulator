...
def samadengan():
    ...
    if mtk == "penjumlahan":
        ...
        try:
            ...
            e.insert(0,'maaf perhitungan salah')
    elif mtk == "sisabagi":
        e.insert(0,n_awal % int(nomor_akhir))
...
tbh = Button(root,text="+",padx=30,bg="#000080", fg="white",pady=20,command=tambah)
krg = Button(root,text="-",padx=30,bg="#0000FF", fg="white",pady=20,command=kurang)
kal = Button(root,text="*",padx=30,bg="#6F00FF", fg="white",pady=20,command=kali)
bag = Button(root,text="/",padx=30,bg="#8F00FF", fg="white",pady=20,command=bagi)
hps = Button(root,text="C",padx=30,bg="#C0C0C0", fg="black",pady=20,command=hapus)
smdg = Button(root,text="=",padx=50,bg="#808080", fg="black",pady=20,command=samadengan)
ak2 = Button(root,text="//2",padx=30,bg="black", fg="white",pady=20,command=akar)
sisa = Button(root,text="=/",padx=30,bg="#FFC0CB", fg="black",pady=20,command=sisabagi)
pang = Button(root,text="x2",padx=30,bg="#964B00", fg="white",pady=20,command=pangkat)
...
smdg.grid(row=5,column=2,pady=2,columnspan=2)
